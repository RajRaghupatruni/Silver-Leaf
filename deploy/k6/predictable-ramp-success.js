...
export default function () {
  ...
  // Rotate connections periodically so newly added Kubernetes endpoints
  // can receive traffic without turning every request into a new TCP connection.
  if (__ITER > 0 && __ITER % 25 === 0) {
