...
$k6JobName = "optiscale-predictable-ramp-success"
$k6ConfigMapName = "optiscale-k6-script-success"
$baselineRate = 200
$baselineSeconds = 65
...
$repoK6Script = (Resolve-Path (Join-Path $PSScriptRoot "..\k6\predictable-ramp-success.js")).Path
$repoK6Job = (Resolve-Path (Join-Path $PSScriptRoot "..\k6\predictable-ramp-success-job.yaml")).Path
...
Invoke-Kubectl -KubectlArgs @("-n", $namespace, "create", "configmap", $k6ConfigMapName, "--from-file=predictable-ramp-success.js=$repoK6Script") | Out-Host
